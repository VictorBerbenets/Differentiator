...
CMP(ARCSIN,  "arcsin",  MUL(DIV(Digit(1), SQRT_(SUB(Digit(1), POW(cL, Digit(2))), nullptr)) , dL), Arcsin)
CMP(ARCCOS,  "arccos",  MUL(DIV(Digit(-1), SQRT_(SUB(Digit(1), POW(cL, Digit(2))), nullptr)) , dL), Arccos)
CMP(ARCTG,   "arctg",   MUL(DIV(Digit(1), ADD(Digit(1), POW(cL, Digit(2)))), dL), Arctg)
CMP(ARCCTG,  "arcctg",  MUL(DIV(Digit(-1), ADD(Digit(1), POW(cL, Digit(2)))), dL), Arcctg)
